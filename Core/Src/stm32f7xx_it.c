...
int DHT11_flag = 0;                                     //定时器5控制DHT11 1s测量一次
/* USER CODE END PV */
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc)
{
   AD_Value[temp_index++] = HAL_ADC_GetValue(&hadc3);
    if (temp_index == 100)
    {
      ...
      tempTemp /= temp_index;
          //printf("tempTemp:%lf\n",tempTemp);
      //temper_analog = (1480 - tempTemp * 3300 / 4096) / 4.3 + 25;
      //temper_analog = ((tempTemp - 1800) * 3300 / 4096) / 57.0958 + 12;
      temper_analog = 0.035 * tempTemp - 55.9715;
      //temper_analog = 0.0133 * tempTemp - 11.1218; 
          //printf("temper_analog:%lf°C\n",temper_analog);
