...
#define ID_BUTTON_7 (GUI_ID_USER + 0x1B)
#define ID_TEXT_19 (GUI_ID_USER + 0x1C)
#define ID_BUTTON_8 (GUI_ID_USER + 0x1D)
...
#define __WINDOWS_DEBUG__                       //是否使用“time.h”获取当前时间

#ifdef  __WINDOWS_DEBUG__
#include <time.h>
#endif
// USER END
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { TEXT_CreateIndirect, "TEM", ID_TEXT_0, 148, 51, 52, 20, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "HUM", ID_TEXT_1, 369, 41, 57, 20, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "Air", ID_TEXT_2, 171, 183, 56, 20, 0, 0x64, 0 },
  ...
  { TEXT_CreateIndirect, "TIME", ID_TEXT_10, 359, 4, 91, 40, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "Reservation", ID_TEXT_11, 30, 120, 113, 20, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "Set_rise", ID_BUTTON_4, 240, 135, 100, 38, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "Set_reduce", ID_BUTTON_5, 350, 135, 100, 38, 0, 0x0, 0 },
  ...
  { TEXT_CreateIndirect, "o", ID_TEXT_16, 197, 50, 12, 11, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "C", ID_TEXT_17, 201, 52, 16, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "DATA", ID_TEXT_18, 223, 2, 127, 40, 0, 0x0, 0 },
  ...
  { TEXT_CreateIndirect, "name", ID_TEXT_19, 0, 0, 202, 37, 0, 0x64, 0 },
  { BUTTON_CreateIndirect, "A/D", ID_BUTTON_8, 116, 61, 30, 20, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    TEXT_SetFont(hItem, GUI_FONT_20B_1);
    //
    // Initialization of 'Set_rise'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_4);
    BUTTON_SetFont(hItem, GUI_FONT_20_1);
    //
    // Initialization of 'Set_reduce'
    //
    ...
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_19);
    TEXT_SetText(hItem, "\xe9\xab\x98\xe6\x88\x90\xe9\x91\xab 17211270 \xe5\xad\x99\xe5\xa4\xa9\xe4\xb8\x80 17211316");
    GUI_UC_SetEncodeUTF8();
    TEXT_SetFont(hItem, &GUI_Fontname);
...
//        printf("%s", asctime(timeCN));
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_3: // Notifications sent by 'MODEL_CHANGE'
      ...
      break;
    case ID_BUTTON_4: // Notifications sent by 'Set_rise'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        if (boot_model == 0)
      ...
      break;
    case ID_BUTTON_5: // Notifications sent by 'Set_reduce'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        if (boot_model == 0)
    ...
    case ID_BUTTON_7: // Notifications sent by 'Boot_model'
      ...
      break;
    case ID_BUTTON_8: // Notifications sent by 'A/D'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        temper_model_change++;
        temper_model_change %= 2;
        hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_8);
        if (temper_model_change == 0)
          BUTTON_SetText(hItem, "D");
        else 
